...
1. **[Key Concepts & Design Philosophy](concepts.md)** — ZotFlow's core model explained. Strongly recommended to read.
2. **[Getting Started](getting-started.md)** — Install ZotFlow, connect your Zotero account, and run your first sync.
3. **[Reading & Annotating](reading-and-annotating.md)** — Open PDFs/EPUBs in the built-in reader and annotate them.
4. **[Source Notes](source-notes.md)** — Create and customize auto-generated source notes for your Zotero items.
